        ...
        - name: CILIUM_CUSTOM_CNI_CONF
          valueFrom:
            configMapKeyRef:
              ...
              name: cilium-config
              optional: true
        image: "registry.suse.de/home/mrostecki/branches/devel/caasp/4.0/containers/containers/caasp/v4/cilium:1.6.3"
        ...
        - name: CILIUM_WAIT_BPF_MOUNT
          valueFrom:
            configMapKeyRef:
              ...
              name: cilium-config
              optional: true
        image: "registry.suse.de/home/mrostecki/branches/devel/caasp/4.0/containers/containers/caasp/v4/cilium-init:1.6.3"
        imagePullPolicy: IfNotPresent
        ...
        - name: CILIUM_IDENTITY_ALLOCATION_MODE
          valueFrom:
            configMapKeyRef:
              ...
              name: cilium-config
              optional: true
        image: "registry.suse.de/home/mrostecki/branches/devel/caasp/4.0/containers/containers/caasp/v4/cilium-operator:1.6.3"
        imagePullPolicy: IfNotPresent
        name: cilium-operator
        livenessProbe:
          httpGet:
