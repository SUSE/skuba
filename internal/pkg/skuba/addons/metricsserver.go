...
// When skuba cluster init, at this time Kubernetes CA does not exist yet, render the caBundle with empty string.
// When skuba bootstrap, the Kubernetes CA file exists (generated by kubeadm or user provides it's custom CA), the
// caBundle will be generated with base64 encoded Kubernetes CA.
