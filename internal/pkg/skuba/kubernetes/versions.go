	...
	supportedVersions = KubernetesVersions{
		"1.16.2": KubernetesVersion{
			ComponentHostVersion: ComponentHostVersion{
				...
				ContainerRuntimeVersion: "1.16.2",
			},
			ComponentContainerVersion: ComponentContainerVersion{
				APIServer:         &ContainerImageTag{Name: "api-server", Tag: "v1.16.2"},
				ControllerManager: &ContainerImageTag{Name: "controller-manager", Tag: "v1.16.2"},
				Scheduler:         &ContainerImageTag{Name: "scheduler", Tag: "v1.16.2"},
				Proxy:             &ContainerImageTag{Name: "proxy", Tag: "v1.16.2"},
